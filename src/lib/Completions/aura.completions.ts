    ...
    let auraSnippets = [
        {
            ...
            detail: "Text input fields are for entering single-line text. (Audibene Code Snippets)",
        ...
        },
        {
            ...
            detail: "Number input fields support decimal, percentage, and currency values. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            ...
            detail: "Search input fields enable search queries (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            ...
            detail: "Date input fields provide a date picker for entering a date. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            ...
            detail: "Time input fields provide a dropdown list of time values (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            ...
            detail: "Date/Time input fields provide a date and time picker for entering a date and time. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            ...
            detail: "File input fields support upload of single or multiple files and can restrict the accepted file types (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            ...
            detail: "Email input fields are for entering email addresses (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            ...
            detail: "Password input fields obscure your text input (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            ...
            detail: "Checkbox options can be required or disabled. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            label: "combobox-aura",
            ...
            detail: "A combobox enables you to select only one option (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            ...
            detail: "Aura Basic Card (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            label: "icon:aura",
            ...
            detail: "Aura Icon (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
            ...
            detail: "Basic Button Aura (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },
        {
        ...
        },
        {
            ...
            detail: "Button Group Aura (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Property,
        },            
        {
            label: "if",
            ...
            detail: "Conditionally instantiates and renders either the body. (Audibene Code Snippets)",
        ...
        },
        {
            ...
            detail: "Conditionally checks if empty and renders either the body. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Method,
        },
        {
            label: "if not empty",
            ...
            detail: "Conditionally checks if not empty and renders either the body. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Method,
        },
        {
            label: "if equals",
            ...
            detail: "Conditionally checks if equals and renders either the body. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Method,
        },
        {
            label: "if not equals",
            ...
            detail: "Conditionally if not equals and renders either the body. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Method,
        },
        {
            label: "if else",
            ...
            detail: "Conditionally instantiates and renders either the body or the components in the else attribute. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Method,
        },
        {
            label: "else",
            ...
            detail: "Renders else attribute (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Method,
        },
        {
            label: "iteration",
            ...
            detail: "Renders a view of a collection of items. Supports iterations containing components that can be created exclusively on the client-side. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Method,
        },
        {
            label: "attribute",
        ...
        },
        {
            ...
            detail: "Add the force:hasRecordId interface to a Lightning component to enable the component to be assigned the ID of the current record (Audibene Code Snippets)",
        ...
        },
        {
            ...
            detail: "Add the force:appHostable interface to a Lightning component to allow it to be used as a custom tab in Lightning Experience or the Salesforce mobile app. Attribute name recordId, type String (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Text,
        },
        {
            ...
            detail: "Add the force:hasSObjectName interface to a Lightning component to enable the component to be assigned the API name of current record’s sObject type. Attribute name sObjectName, type String (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Text,
        },
        {
            ...
            detail: "Add the force:lightningQuickAction interface to a Lightning component to allow it to be used as a custom action in Lightning Experience or the Salesforce mobile app (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Text,
        },
        {
            ...
            detail: "Add the force:lightningQuickActionWithoutHeader interface to a Lightning component to allow it to be used as a custom action in Lightning Experience or the Salesforce mobile app (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Text,
        },
        {
            ...
            detail: "To make your component available for record pages and any other type of page, implement the flexipage:availableForAllPageTypes interface (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Text,
        },
        {
            ...
            detail: "To make your component available for record pages only, implement the flexipage:availableForRecordHome interface. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Text,
        },
        {
            label: "init",
            ...
            detail: "This event is automatically fired when an app or component is initialized, prior to rendering. (Audibene Code Snippets)",
            kind: vscode.CompletionItemKind.Method,
        },
    ];
